<nav x-data="{ open: false }" class="bg-green-700 border-b border-green-700 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-white hover:text-green-100 transition-colors">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-bold rounded-md text-green-700 bg-white hover:bg-green-50 focus:outline-none transition ease-in-out duration-150 shadow-sm">
